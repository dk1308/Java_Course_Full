...
public class RutThamTrungThuongTestTreeSet {
	private Set<String> rt = new TreeSet<String>();

	public RutThamTrungThuongTestTreeSet(Set<String> sr) {
		this.rt = rt;
	}
	public RutThamTrungThuongTestTreeSet() {
