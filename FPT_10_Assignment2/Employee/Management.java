	...
	//	-----Hàm tính allowance
		public void calAllowance()
		{
			...
			if(((current_date.getYear()-this.workStartingDate.getYear()==3) && (current_date.getMonth()>=this.workStartingDate.getMonth()))
					|| (current_date.getYear()-this.workStartingDate.getYear()>3))
			{
