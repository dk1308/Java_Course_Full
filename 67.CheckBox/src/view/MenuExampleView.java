...
public class MenuExampleView extends JFrame {
	...
	public MenuExampleView() {
		...
		JMenu jMenu_toolbar = new JMenu("Toolbar");
		jMenu_toolbar.setMnemonic(KeyEvent.VK_T);
		jMenu_toolbar.setDisplayedMnemonicIndex(0);
		...
		JCheckBoxMenuItem jCheckBox_toolbar = new JCheckBoxMenuItem("Display toolbar");
		jCheckBox_toolbar.addActionListener(menuExampleController);
		...
		jMenu_toolbar.add(jCheckBox_toolbar);
		
		// Thêm các menu vào thanh menu
		jMenuBar.add(jMenu_file);
		jMenuBar.add(jMenu_help);
		jMenuBar.add(jMenu_toolbar);
